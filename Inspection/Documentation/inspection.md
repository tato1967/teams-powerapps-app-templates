...
1. Select ![App settings to customize experience.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/teams-settings.png "App settings to customize experience") from the upper-right corner.
...
1. Select **Save** to save the changes to label setup.
    ...
    ![Customize experience.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/customize-experience.png "Customize experience")
...
1. Select **Let's go**.
    ...
    ![Integrate with channel and planner.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/channel-planner-integrate.png "Integrate with channel and planner")
...
1. Select ![Teams settings for managing inspections.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/teams-settings.png "Teams settings for managing inspections") from the upper-right corner.
...
1. Select **Save**.
    ...
    ![Edit app configuration.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/edit-app-configuration.png "Edit app configuration")
...
1. Select ![Teams settings for locations.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/teams-settings.png "Teams settings for locations") from the upper-right corner.
...
1. Select **Save**.
    ...
    ![Add location type.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/add-location-type.png "Add location type")
...
1. Select **Save**.
    ...
    ![Add location.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/add-location.png "Add location")
...
1. Select **Save**.
    ...
    ![Add inspection form.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/add-inspection-form.png "Add inspection form")
...
1. In the **Inspections** section, select a submitted inspection.
    ...
    ![Select submitted inspection.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/select-submitted-inspection.png "Select submitted inspection")

1. Review the submitted inspection details as required.

    ![Review submitted inspection.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/review-submitted-inspection.png "Review submitted inspection")
...
1. Select **Inspection insights** tab inside the app.
    ...
    ![Inspection insights.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/inspection-insights.png "Inspection insights")
...
![Home screen without Planner.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/home-screen-without-planner.png "Home screen without Planner")
...
![Inspect a location.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/inspect-location.png "Inspect a location")
...
![Select an inspection form.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/select-inspection-form.png "Select an inspection form")
...
![Inspection overview.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/inspection-overview.png "Inspection overview")
...
![Inspection form.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/inspection-form.png "Inspection form")
...
![Add a Planner task to an inspection step.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/add-task-to-inspection.png "Add a Planner task to an inspection step")

If the Planner isn't integrated from the manager app, you can't create tasks and the following screen is displayed.

![Planner not integrated.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/planner-not-integrated.png "Planner not integrated")
...
![Review inspection.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Area%20Inspection/Documentation/media/inspection/review-inspection.png "Review inspection")
